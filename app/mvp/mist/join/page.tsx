...
export default function MistJoin() {
  const guestRoster: RosterMember[] = [
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-[#0a0614] px-6 py-10 text-zinc-100">
      <div className="w-full max-w-sm rounded-2xl border border-[#C2410C]/40 bg-[#C2410C]/10 px-5 py-3 text-center backdrop-blur-md">
        <p className="text-sm font-semibold text-[#f0a878]">
          You joined as Duskfang 🐉
        </p>
        <p className="text-xs text-zinc-400">
          Welcome to {activeRoom.emoji} {activeRoom.name}
        </p>
      </div>
      ...
      >
        <div className="flex items-center justify-between px-4 pb-2">
          <span className="text-xs text-zinc-500">Guest session</span>
        ...
        <div className="relative flex-1">
          <FauxMap variant="mist" members={guestRoster} className="h-full" />
